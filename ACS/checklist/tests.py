...
class TestChecklist(unittest.TestCase):
    ...
    def test_login_student(self):
        ...
        response = self.client.post('/login/0', {'username': 'student', 'password': 'Iheartschool'})
    ...
    def test_failed_login(self):
        response = self.client.post('/login/0', {'username': 'skateboarddude24', 'password': 'halfpipe'})
        self.assertEqual(response.status_code, OK)
    ...
    def test_program_detail(self):
        self.client.post('/studentCreateAccount/', {'username': 'student', 'password': 'Iheartschool',
                                                    'password_reenter': 'Iheartschool'})
        self.client.post('/login/0', {'username': 'student', 'password': 'Iheartschool'})
    ...
    def test_default_empty_checklist(self):
        ...
        self.client.post('/studentCreateAccount/', {'username': 'studentt', 'password': 'Iheartschool',
                                                    'password_reenter': 'Iheartschool'})
        self.client.post('/login/0', {'username': 'studentt', 'password': 'Iheartschool'})
        response = self.client.get('/checklist/')
        self.assertTrue(response.context['checklists'] == [])
'''
...
class FunctionalTests(TestCase):
    ...
    def test_postSuccess(self):
        self.client = Client()
        response = self.client.post('/login/0', {'username': 'staff', 'password': 'teacher'})
        response = self.client.post('/createProgram/', {'university_name': 'School of Dummy',
                                             ...
                                             'references': True,
                                             'official_transcript': True})
        self.assertTrue(Program.objects.get(Degree='masters'))
